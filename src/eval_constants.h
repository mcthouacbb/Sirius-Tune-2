...
constexpr PackedScore KING_ATTACKS = S(   0,    0);//{S( -37,    8), S( -44,    6), S( -49,    4), S( -52,    7), S( -51,    6), S( -44,    4), S( -29,    0), S( -12,   -8), S(  16,  -20), S(  37,  -15), S(  56,  -26), S(  59,   18), S(  83,  -20), S(  69,   29)};
constexpr PackedScore WEAK_KING_RING = S(   0,    0);//[17] = {S( -30,   47), S( -29,   27), S( -24,   24), S( -21,   20), S( -14,   13), S(  -5,    6), S(   5,    1), S(  20,   -3), S(  36,   -6), S(  50,   -9), S(  62,  -12), S(  66,   -8), S(  77,  -11), S(  79,  -13), S(  79,   -9), S(  99,  -14), S( 108,  -15)};

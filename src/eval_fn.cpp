...
constexpr InitialParam MATERIAL[6] = {
...
constexpr InitialParam PASSED_PAWN[8] = {S(   0,    0), S(  -5,   12), S(  -9,   17), S(  -8,   40), S(  12,   62), S(   3,  125), S(  23,  102), S(   0,    0)};
constexpr InitialParam ISOLATED_PAWN[8] = {S( -10,  -11), S(  -7,  -15), S( -18,  -17), S( -18,  -22), S( -21,  -24), S( -15,  -14), S( -10,  -14), S( -21,  -10)};

constexpr InitialParam BISHOP_PAIR = S(21, 64);

constexpr InitialParam ROOK_OPEN[2] = {S(32, 8), S(13, 11)};

...
constexpr InitialParam MATERIAL[6] = {S(  59,   86), S( 290,  360), S( 295,  380), S( 408,  668), S( 857, 1219), S(0, 0)};
...
constexpr InitialParam THREAT_BY_PAWN[6] = {S(   7,  -14), S(  64,   25), S(  64,   57), S(  89,    6), S(  76,  -23), S(   0,    0)};
...
constexpr InitialParam ISOLATED_PAWN[8] = {S(  -3,    6), S(  -3,  -11), S( -11,   -5), S(  -6,  -13), S( -11,  -13), S(  -7,   -4), S(  -1,  -12), S(  -9,    7)};
constexpr InitialParam PAWN_PHALANX[8] = {S(   0,    0), S(   5,   -2), S(  12,    6), S(  18,   16), S(  45,   55), S( 117,  178), S(-176,  447), S(   0,    0)};
constexpr InitialParam DEFENDED_PAWN[8] = {S(   0,    0), S(   0,    0), S(  18,   10), S(  12,    7), S(  13,   15), S(  29,   39), S( 169,   27), S(   0,    0)};
constexpr InitialParam OUR_PASSER_PROXIMITY[8] = {S(   0,    0), S(   5,   52), S(  -6,   39), S(  -5,   23), S(  -2,   13), S(   2,   10), S(  16,    8), S(   6,    7)};
...
constexpr InitialParam KING_ATTACKER_WEIGHT[4] = {S(  15,   -3), S(   8,    2), S(   6,  -13), S(  -3,   14)};
constexpr InitialParam KING_ATTACKS[14] = {S( -27,   12), S( -29,    7), S( -30,    4), S( -28,    8), S( -20,    4), S(  -3,   -1), S(  20,   -9), S(  50,  -24), S(  95,  -46), S( 125,  -50), S( 162,  -66), S( 186,  -55), S( 219, -133), S( 186,   -8)};

constexpr InitialParam KNIGHT_OUTPOST = S(  24,   20);
